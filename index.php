...
mkdir("data");
$reklama = "@Akhatkulov <b>bot yaratish xizmati!</b>";
$kanal1 = file_get_contents('data/kanal1.txt');
$kanal2 = file_get_contents('data/kanal2.txt');
$kanal3 = file_get_contents('data/kanal3.txt');
$kanal4 = file_get_contents('data/kanal4.txt');
$kanal5 = file_get_contents('data/kanal5.txt');
$kanal6 = file_get_contents('data/kanal6.txt');
$kanal7 = file_get_contents('data/kanal7.txt');
$kalit = file_get_contents('data/kalit.txt');
